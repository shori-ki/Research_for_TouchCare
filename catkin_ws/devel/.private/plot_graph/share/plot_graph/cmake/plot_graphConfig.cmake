...
if(NOT "/root/catkin_ws/devel/.private/plot_graph/include " STREQUAL " ")
  set(plot_graph_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/plot_graph/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plot_graph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/plot_graph/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/plot_graph/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
